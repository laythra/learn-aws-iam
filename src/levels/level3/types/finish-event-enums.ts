...
export enum EdgeConnectionFinishEvent {
  ...
  CLOUDFRONT_INVALIDATION_POLICY_CONNECTED = 'CLOUDFRONT_INVALIDATION_POLICY_CONNECTED',
...
export enum NodeCreationFinishEvent {
  ...
  CF_DISTRIBUTION_INVALIDATION_POLICY_CREATED = 'CF_DISTRIBUTION_INVALIDATION_POLICY_CREATED',
}
