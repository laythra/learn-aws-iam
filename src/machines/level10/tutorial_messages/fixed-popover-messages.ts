...
const FIXED_POPOVER_MSG1 = `
  For this level, you will see a bunch of teams that currently have no access to any Resource.

  The goal is to allow each of these teams to create their own RDS instance
  with the appropriate tags, and ultimately precvent
